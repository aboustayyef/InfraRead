        ...
        <div class="bg-white shadow rounded p-6 space-y-4">
            ...
            <form method="POST" action="{{ route('admin.token.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="dev" class="mt-1 w-full sm:w-64 border rounded p-2" />
                    <p class="text-xs text-gray-500 mt-1">If a token with this name exists it will be replaced.</p>
                </div>
                <button class="w-full sm:w-auto bg-indigo-600 text-white px-4 py-2 rounded">Generate Token</button>
            </form>
        </div>
