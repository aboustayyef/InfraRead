<template>
            <div class="realtive">
                ...
                >
                    <div v-if="shown" class="w-full px-4 mx-auto mt-12 max-w-7xl md:px-12 pb-72">
                        ...
                        <div v-html="post.content" class="text-xl font-light leading-relaxed text-gray-700 content has-columns">
                        </div>
                    </div>
