<template>
    <div
        class="relative w-full h-screen p-4 pt-12 overflow-y-auto text-left md:p-12"
    >
        <!-- Loading Indicator -->
        <div
            v-cloak
        ...
        >
            <!-- Logo -->
            <a href="/"
                ><img class="h-8 md:h-12" src="/img/infraread144.png"
            /></a>
            ...
            <div class="flex align-center">
                ...
                <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    xml:space="preserve"
                    class="h-8 text-gray-300 cursor-pointer hover:text-primary mr-4"
                    fill="currentColor"
                ...
                <a href="/admin" class="block">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-8 text-gray-300 cursor-pointer hover:text-primary"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
        ...
        <div v-if="number_of_unread_posts < 1" class="container mx-auto">
            <svg
                ...
                data-name="Layer 1"
                xmlns="http://www.w3.org/2000/svg"
                class="mt-12 w-1/3 mx-auto"
                viewBox="0 0 640.65724 577.17886"
            >
                <path
        ...
        <!-- List of Posts -->
        <div
            v-for="(post, index) in unread_posts"
            :key="post.id"
        ...
        >
            ...
            <div class="w-1/2 mb-6">
                <button
                    v-on:click="mark_post_as_read(post)"
        ...
        <!-- Messages -->
        <div
            class="fixed inline-block px-8 py-2 transition duration-75 ease-out transform border border-gray-600 shadow-md translate-x-72 top-8 right-8"
            :class="{
  ...
  created() {
      ...
      window.addEventListener('keydown', (e) => {
        window.keys_entered += e.key;
            setTimeout(() => { // allow time to enter more keys
                if (window.key_entered !== '') {
